package com.bank.compte.config;
...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, ClientCreatedEvent> consumerFactory() {
        ...
        props.put(JsonDeserializer.TRUSTED_PACKAGES, "com.bank.compte.dto.events");
        props.put(ConsumerConfig.AUTO_OFFSET_RESET_CONFIG, "earliest");

        return new DefaultKafkaConsumerFactory<>(
            props,
            new StringDeserializer(),
            new JsonDeserializer<>(ClientCreatedEvent.class, false)
        );
    }
